...
{
    public sealed class FleeScene : Scene
    {
        private Vehicle _mainEntity;
        private Vehicle _target;


        public FleeScene(SceneManager manager)
            : base(manager)
        {
        }
        ...
        public override void Init()
        {
            ...
            _mainEntity.Behavior.ToAvoid = _target;
        }
            ...
            foreach (Keys key in currentPressedKeys)
            {
                switch (key)
                {
                    case Keys.N:
                        ...
                        break;
                    case Keys.P:
                        Manager.ChangeScene(new ArriveScene(Manager));
                        break;
                }
            }
        }
